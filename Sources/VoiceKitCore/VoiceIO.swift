...
public final class RealVoiceIO: NSObject, VoiceIO, TTSConfigurable {
    ...
    private struct BoostWaiterSink: @unchecked Sendable {
        weak var owner: RealVoiceIO?
        func completeAll() { Task { @MainActor in owner?.completeBoostWaiters() } }
        func finish(id: UUID) { Task { @MainActor in owner?.finishBoostWaiter(id: id) } }
    }
    ...
    public func prepareBoosted(url: URL, gainDB: Float) async throws {
        ...
        let sink = BoostWaiterSink(owner: self)
    ...
    public func startPreparedBoosted() async throws {
        ...
        // If work already done, return quickly
