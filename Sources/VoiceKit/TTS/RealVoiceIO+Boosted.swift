...
extension RealVoiceIO {
    ...
    private static var _avClipPlayerStorage = [ObjectIdentifier: AVAudioPlayer]()
    ...
    internal var avClipPlayer: AVAudioPlayer? {
        get { RealVoiceIO._avClipPlayerStorage[objID] }
        set { RealVoiceIO._avClipPlayerStorage[objID] = newValue }
    }
