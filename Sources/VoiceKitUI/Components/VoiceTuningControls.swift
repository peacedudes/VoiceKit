...
//  VoiceKitUI
//
//  Reusable controls for tuning Speed (rate), Pitch, and optionally Volume.
//  Intended for use in ChorusLabView and VoiceChooserView to ensure consistent UX.
//
...
@MainActor
internal struct VoiceTuningControls: View {
    // Bindings
...
internal struct VoiceTuningConfig {
    // Visibility
    ...
    static let `default` = VoiceTuningConfig(
        showVolume: true,
...
internal struct VoiceTuningLabels {
    var rate: String
    var pitch: String
    var volume: String
    var rateHint: String
    ...
    static let `default` = VoiceTuningLabels(
        rate: "Speed",
        pitch: "Pitch",
        volume: "Volume",
